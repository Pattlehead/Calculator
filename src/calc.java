...
public class calc {
                ...
                if (temp[i] == '+' || temp[i] == '-' || temp[i] == '*' || temp[i] == '/') {
                    if (roman) {
                        try {
                            ...
                            System.out.println("Ошибка. Складывать можно только одинаковые форматы чисел.");
                            System.exit(0);
                        }
                    }
                    else {
    ...
    static int toArab(String num) {
        ...
        switch (num) {
            ...
            default -> {
                ...
                System.out.println("Ошибка. Используйте римские цифры от I до X.");
                System.exit(0);
                return 0;
            }
        }
    ...
    static String toRoman(int num) {
        switch (num) {
            ...
            case 100 -> { return "C"; }
            default -> {
                System.out.println("Ошибка. Результат работы с римскими числами может быть только больше 0.");
                System.exit(0);
                return"";
            }
        }
